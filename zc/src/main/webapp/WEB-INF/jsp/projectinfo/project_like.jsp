 ...
 <table border="0" cellpadding="0" cellspacing="0" class="tableStyle thback">
          <tbody><tr>
            ...
            <th>操作</th>
             ...
             <span style="vertical-align: top;line-height: 30px;"> <a href="projectinfo/project_<c:out value="${pro.zcProjectInfo.proCode}"></c:out>.html"> <c:out value="${pro.zcProjectInfo.proName}"></c:out></a></span>
               </td>
